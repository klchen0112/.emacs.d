...
#+begin_src emacs-lisp
  (defconst main-fonts
    '((default        . "M+1Code Nerd Font Mono")
  ...
  ;; 设置符号字体
  (defun get-symbol-fonts ()
    "Get appropriate symbol fonts based on platform."
    (let ((base-fonts '("Symbola"
                        "Noto Color Emoji"
                        "Liberation Mono"
                        "Noto Sans Symbols2"
                        "Segoe UI Emoji"
                        ...
                        "Twitter Color Emoji")))
      (if IS-MAC
          (append '("Apple Symbols" "Apple Color Emoji") base-fonts)
        base-fonts)))

  (defconst symbol-fonts (get-symbol-fonts)
    "Fonts used for symbols")
  (defun my-fonts ()
    ;; 设置主字体

    (dolist (face main-fonts)
    ...
    ;; Cyrillic: Привет, Здравствуйте, Здрав, Здравейте
...
#+begin_src emacs-lisp
  ...
  (setup switch-window
    ...
    (:load-after window-divider-mode)
