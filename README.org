...
*** init.el
:PROPERTIES:
:ID:       2c0ad3c0-5c70-458e-b8dd-fa5f84235ca1
:END:
...
*** early-init.el :early:
:PROPERTIES:
:ID:       16dfc3df-f471-4217-8e8d-ff1fe988a83a
:END:
...
** disable package.el
:PROPERTIES:
:ID:       41b3439b-9556-4996-a14d-6dbf3ac26dd6
:END:
...
** Setup.el :early:
:PROPERTIES:
:ID:       17c84aba-c415-48be-ab24-fb365871c4ba
:END:
...
*** package
:PROPERTIES:
:ID:       0f48d53a-445c-48c5-bcc4-ac02d233a780
:END:
...
*** :defer
:PROPERTIES:
:ID:       7e66b043-c29f-4ffe-a7e7-7c2fde0d370a
:END:
...
*** :reformatters
:PROPERTIES:
:ID:       b4a4a04d-1cfb-4e73-9da8-434b45b7d432
:END:
#+begin_src emacs-lisp
  (eval-when-compile
    (setup-define
...
*** :load-after
:PROPERTIES:
:ID:       fef607b9-1308-4198-8098-f579ec11dda0
:END:
#+begin_src emacs-lisp
  (eval-when-compile
...
*** :nixpkgs
:PROPERTIES:
:ID:       6739395e-3378-4c37-b1c1-cd8498f9fdd4
:END:
...
*** :eglot-server
:PROPERTIES:
:ID:       d6838d25-be35-494d-a617-0c6317bd33bf
:END:
#+begin_src emacs-lisp
  (eval-when-compile
    (setup-define
...
*** :prefix-map
:PROPERTIES:
:ID:       5589fa52-9709-4d88-9a22-9f6e7136ae34
:END:
#+begin_src emacs-lisp
...
** Indentation guides
:PROPERTIES:
:ID:       06bf00f5-6615-4344-b5ed-b37ab05dc3e9
:END:
#+begin_src emacs-lisp
(setup indent-bars
       (:package indent-bars)
...
*** eat
:PROPERTIES:
:ID:       3313008d-38fa-498a-a9e8-9633e81c2560
:END:
#+begin_src emacs-lisp
(setup eat
       (:package eat))
...
** Check
:PROPERTIES:
:ID:       d7a0b0df-1af2-40c5-9cb6-cafbb86f78e8
:END:
